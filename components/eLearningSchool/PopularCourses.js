                ...
                <div className="row">
                    <div className="col-lg-4 col-md-6">
                        <div className="single-courses-box">
                            <div className="courses-image">
                                ...
                                <Link href="#">
                                    <li className="fav"><i className="flaticon-heart"></i></li>
                                </Link>
                    ...
                    <div className="col-lg-12 col-md-12">
                        <div className="courses-info">
                            <p>Enjoy the top notch learning methods and achieve next level skills! You are the creator of your own career & we will guide you through that. <Link href="/profile-authentication"><li>Register Free Now!</li></Link>.</p>
                        </div>
                    </div>
                </div>
            </div>
