                ...
                <div className="row">
                    <div className="col-lg-4 col-md-6">
                        <div className="single-blog-post">
                            ...
                            <div className="post-content">
                                ...
                                <h3>
                                    <Link href="/single-blog-1">
                                        <li>University Admissions Could Face Emergency Controls</li>
                                    </Link>
                                </h3>
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className="single-blog-post">
                            ...
                            <div className="post-content">
                                ...
                                <h3>
                                    <Link href="/single-blog-1">
                                        <li>Online Learning Can Prepare Students For A Fast-Changing</li>
                                    </Link>
                                </h3>
                                <ul className="post-content-footer d-flex justify-content-between align-items-center">
                                    <li>
                    ...
                    <div className="col-lg-4 col-md-6 offset-lg-0 offset-md-3">
                        <div className="single-blog-post">
                            ...
                            <div className="post-content">
                                ...
                                <h3>
                                    <Link href="/single-blog-1">
                                        <li>As Learning Moves Online, Trigger Warnings Must Too</li>
                                    </Link>
                                </h3>
                                <ul className="post-content-footer d-flex justify-content-between align-items-center">
                                    <li>
                    ...
                    <div className="col-lg-12 col-md-12">
                        <div className="blog-post-info">
                            <p>Get into details now?​ <Link href="/blog-1"><li>View all posts</li></Link></p>
                        </div>
                    </div>
                </div>
            </div>
